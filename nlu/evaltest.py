...
#     sentences,
#     "results\\stack_reports\\with_entity2.csv",
#     trim_count=2,
# )
...
dict_comparison = DictComparison(
    ...
    out_file_path="results\\stack_entity_reports\\entity_result_single8.txt",
)
